...
\ahref{https://htmlpreview.github.io/?https://github.com/eisop/checker-framework/master/docs/developer/developer-manual.html}{Checker
...
Override
\<MyChecker.\refmethodterse{common/basetype}{BaseTypeChecker}{getImmediateSubcheckers}{--}>
...
It is possible to have multiple subcheckers of the same class type. This is useful
if the same checker can be run multiple times on the same project with different
configurations. In this case, the subchecker class should override
\<hashCode> and \<equals> to uniquely identify every instance; the default
implementation of these methods considers every checker instance of the
same class type to be equal.
